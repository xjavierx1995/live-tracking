...
## Purpose
Proporcionar la autenticación de usuarios en el frontend (login, registro, logout, protección de rutas y persistencia de sesión).
...
- **WHEN** el usuario recarga la página teniendo iniciado sesión previamente
