# Capability: simulator-ors-route-provider

## Purpose

Define the contract for the OpenRouteService route provider in the Tracking Simulator, enabling real route retrieval via ORS API with synthetic fallback.
